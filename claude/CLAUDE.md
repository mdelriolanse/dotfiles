<!-- Migrated from opencode by dotfiles. Source content: opencode/AGENTS.md + opencode/instructions/*.md -->
<!-- This is a standalone copy for Claude Code; edit here (drift from opencode is expected per the copy strategy). -->
