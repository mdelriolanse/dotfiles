---
name: agentmemory-conventions
description: Rules for using Agent Memory MCP — search-first, save triggers, deduplication, quality bar, session handoff. Always active.
